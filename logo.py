...
class Logo:
    ...
    def draw_words(self):
        my_font = pygame.font.SysFont("Helvetica", 22)
        my_font2 = pygame.font.SysFont("Helvetica", 18)
        my_label = my_font.render("Sandy Spring Friends School", 1, self.WHITE)
        my_label2 = my_font2.render("Let Your Lives Speak", 1, self.WHITE)
        self.main_surface.blit(my_label, (75, 120))
        self.main_surface.blit(my_label2, (135, 150))
        pygame.display.update()